...
function tab(){
	var hgt=document.getElementById('ht').style.height;
	var spl=hgt.split('p');
	var l=parseInt(spl[0])+parseInt(380);
	document.getElementById("ht").style.height=l+"px";
	var tbl = document.getElementById('foobar');
   for(j=0;j<5;j++){
   ...
   /* alert(el.name);*/
    ...
    var textNode2 = document.createTextNode("Video URL");
    cellLeft1.appendChild(textNode2);

    var cellLeft2 = row.insertCell(2);
    var textNode3 = document.createTextNode(""); 
     cellLeft2.appendChild(textNode3);

    // right cell
    var cellRight1 = row.insertCell(3);
    var el1 = document.createElement('input');
    el1.style.width="240px";
    el1.value = "";
    el1.type = 'text';
    el1.id = 'url'+k;
    el1.name = 'url'+k;
